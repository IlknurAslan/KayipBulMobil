...
public class NesneKayipAdapter extends ArrayAdapter<KayipPaylasModel> {
    LayoutInflater layoutInflater;
    ArrayList<KayipPaylasModel> nesnepaylasilanlist;
    ...
    public NesneKayipAdapter(Context context, List<KayipPaylasModel> nesnepaylasilanlist) {
        super(context, 0, nesnepaylasilanlist);
        layoutInflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        this.nesnepaylasilanlist = (ArrayList<KayipPaylasModel>) nesnepaylasilanlist;
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        View v = convertView;
        final NesneKayipAdapter.ViewHolder holder;
        if (v == null) {

            LayoutInflater vi =
                    (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            v = vi.inflate(R.layout.kayipnesne_list_item, null);

            holder = new NesneKayipAdapter.ViewHolder();
            ...
            holder = (NesneKayipAdapter.ViewHolder) v.getTag();
        }
        KayipPaylasModel kayipPaylasModel = nesnepaylasilanlist.get(position);
