...
public class InsanKayipAdapter  extends ArrayAdapter<KayipPaylasModel> {

    LayoutInflater layoutInflater;
    ArrayList<KayipPaylasModel> insanpaylasilanlist;
    ...
    public InsanKayipAdapter(Context context, List<KayipPaylasModel> insanpaylasilanlist) {
        super(context, 0, insanpaylasilanlist);
        layoutInflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        this.insanpaylasilanlist = (ArrayList<KayipPaylasModel>) insanpaylasilanlist;
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        View v = convertView;
        final InsanKayipAdapter.ViewHolder holder;
        if (v == null) {

            LayoutInflater vi =
                    (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            v = vi.inflate(R.layout.insan_list_item, null);

            holder = new InsanKayipAdapter.ViewHolder();
            ...
            holder = (InsanKayipAdapter.ViewHolder) v.getTag();
        }
        KayipPaylasModel kayipPaylasModel = insanpaylasilanlist.get(position);
